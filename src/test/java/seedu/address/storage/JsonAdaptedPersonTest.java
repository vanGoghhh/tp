...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_EXPERIENCE,
                        VALID_DATE, VALID_ADDRESS, VALID_URL_LINK, VALID_SALARY, VALID_TAGS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, INVALID_PHONE, VALID_EMAIL, VALID_EXPERIENCE,
                        VALID_DATE, VALID_ADDRESS, VALID_URL_LINK, VALID_SALARY, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, null, VALID_EMAIL, VALID_EXPERIENCE,
                        VALID_DATE, VALID_ADDRESS, VALID_URL_LINK, VALID_SALARY, VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, INVALID_EMAIL, VALID_EXPERIENCE,
                        VALID_DATE, VALID_ADDRESS, VALID_URL_LINK, VALID_SALARY, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, null, VALID_EXPERIENCE,
                        VALID_DATE, VALID_ADDRESS, VALID_URL_LINK, VALID_SALARY, VALID_TAGS);
    ...
    public void toModelType_invalidExperience_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, INVALID_EXPERIENCE,
                        VALID_DATE, VALID_ADDRESS, VALID_URL_LINK, VALID_SALARY, VALID_TAGS);
    ...
    public void toModelType_nullDate_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_EXPERIENCE,
    ...
    public void toModelType_invalidDate_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_EXPERIENCE,
                        INVALID_DATE, VALID_ADDRESS, VALID_URL_LINK, VALID_SALARY, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_EXPERIENCE,
                        VALID_DATE, INVALID_ADDRESS, VALID_URL_LINK, VALID_SALARY, VALID_TAGS);
    ...
    public void toModelType_invalidUrlLink_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_EXPERIENCE,
                        VALID_DATE, VALID_ADDRESS, INVALID_URL_LINK, VALID_SALARY, VALID_TAGS);
    ...
    public void toModelType_invalidSalary_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_EXPERIENCE,
                        VALID_DATE, VALID_ADDRESS, VALID_URL_LINK, INVALID_SALARY, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_EXPERIENCE,
                        VALID_DATE, VALID_ADDRESS, VALID_URL_LINK, VALID_SALARY, invalidTags);
