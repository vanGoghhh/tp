...
public class AddPersonCommandParserTest {
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                        + ADDRESS_DESC_BOB + VALID_EXPERIENCE_BOB,
                expectedMessage);

        // missing experience prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                        + ADDRESS_DESC_BOB + EXPERIENCE_DESC_BOB + VALID_DATE_BOB,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_BOB + VALID_PHONE_BOB + VALID_EMAIL_BOB
                        + VALID_ADDRESS_BOB + VALID_EXPERIENCE_BOB + VALID_DATE_BOB,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + EXPERIENCE_DESC_BOB + URL_LINK_DESC_BOB + DATE_DESC_BOB
        ...
        // invalid address
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + INVALID_ADDRESS_DESC + EXPERIENCE_DESC_BOB + URL_LINK_DESC_BOB + DATE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Address.MESSAGE_CONSTRAINTS);

        // invalid experience
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + INVALID_EXPERIENCE_DESC + URL_LINK_DESC_BOB + DATE_DESC_BOB
        ...
        // invalid url link
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + EXPERIENCE_DESC_BOB + INVALID_URL_LINK_DESC + DATE_DESC_BOB
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                ...
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND + DATE_DESC_BOB, Salary.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + EXPERIENCE_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND
                + URL_LINK_DESC_BOB + DATE_DESC_BOB,
