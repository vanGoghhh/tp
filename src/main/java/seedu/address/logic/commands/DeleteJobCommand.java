...
public class DeleteJobCommand extends Command {
    ...
    public static final String COMMAND_WORD = "delete job";

    public static final String MESSAGE_USAGE = COMMAND_WORD
            + ": Deletes the job identified by the index number used in the displayed person list.\n"
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        return new CommandResult(String.format(MESSAGE_DELETE_JOB_SUCCESS, jobToDelete), Job.TAB_NAME);
    }
